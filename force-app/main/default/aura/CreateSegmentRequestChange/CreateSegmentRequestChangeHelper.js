({
    ...
    handleShowNoticeHelpernogrps : function(component, msg) {
     ...
     var action = component.get("c.savesegment");
        ...
        // var segSize=allsegments.length();
         var counter =0;
         //allsegmentsllop
         for (var i in allsegments) {
             ...
             if (allsegments[i].proposedresponsibleSeller!= '' && allsegments[i].proposedresponsibleSeller!= null){
                 ...
                 if(allsegments[i].proposedresponsibleSeller == allsegments[i].responsibleSeller){
                   ...
                   if (allsegments[i].responsibleSellermanagerstatusvalue == 'false' ){
                    	 this.handleShowNoticeHelper(component,'Manager is inactive  for current Sales responsible '); 
                        return false;	
                    }
                 
                 
                 
                 if (allsegments[i].proposedresponsibleSellermanagervaluestatus == 'false' ){
                    	 this.handleShowNoticeHelper(component,'Manager is inactive  for proposed Sales responsible '); 
                        return false;	
                    }
