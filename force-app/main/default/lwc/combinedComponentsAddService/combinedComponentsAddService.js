...
export default class CombinedComponentsAddService extends NavigationMixin(LightningElement) {
...
handleChange2(event) {
    ...
    this.strcrm_Local__c=event.detail.value2;
}

handleChange4(event) {
   // this.value4 = event.detail.value4;
    this.strcrm_Conversion_Factor__c= event.detail.value4;
}
